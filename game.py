...
class WOFHumanPlayer(WOFPlayer):
    """This class is going to represent a human player."""
    def getMove(self, category, obscuredPhrase, guessed):
        prompt = """{} has ${} \n Category: {}\n Phrase: {}\n Guessed: {}\n
        Guess a letter, phrase, or type 'exit' or 'pass': """.format(self.name,
                                                                     self.prizeMoney,
                                                                     category,
                                                                     obscuredPhrase,
                                                                     guessed)
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def smartCoinFlip(self):
        ...
        if rand_numb > self.difficulty:
            return False
        elif rand_numb <= self.difficulty:
            return True
    def getPossibleLetters(self, guessed):
        ...
        for letters in LETTERS:
            if letters not in guessed:
                if VOWEL_COST > self.prizeMoney and letters in VOWELS:
                    continue
